...
export interface MatchVideo {
   ...
   *  exactly the index intake: one token covering seventeen organisers. The
   *  engine prints the first one present INSTEAD of the source name. Both
   *  absent on every channel record, where the configured name is the truth. */
  event?: string;
  channelName?: string;
