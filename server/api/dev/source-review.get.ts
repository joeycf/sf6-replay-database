...
export default defineEventHandler(() => {
  ...
  //
  // The comparison is the UNORDERED PAIR of character sets, because neither
  // side array is in a trustworthy order — the extractor's is screen order, the
  // verdict's is whatever order the reviewer left the form in, and Evo's titles
  // name the left player second often enough that comparing positionally would
  // flag a large share of the corpus purely on data-entry order.
